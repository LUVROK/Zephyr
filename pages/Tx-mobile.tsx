...
import designTX1 from "../assets/image/designTX1.webp";
import designTX2 from "../assets/image/designTX2.webp";
import { motion } from "framer-motion";
import { gsap } from "gsap";
import ScrollTrigger from "gsap/dist/ScrollTrigger";
import { textAnimationCustom } from "../utils/framerTextAnimation";
...
export default function TxMobile() {
    ...
    <div className={styles.container} style={{ backgroundColor: "#ECE7E3" }}>
      <div className={styles.Wrapper} data-scroll data-scroll-position="top" data-scroll-speed="-2">
        ...
        <div className={styles.Wrapper__left}>
          ...
          <motion.h2 initial="hidden" whileInView="visible" variants={textAnimationCustom} custom={0.25}>
            How we Improve UX in TX.Mobile
          </motion.h2>
          <motion.p initial="hidden" whileInView="visible" variants={textAnimationCustom} custom={0.5}>
      ...
      <div className={styles.content} data-scroll data-scroll-position="top" data-scroll-speed="2">
        ...
        <div className={styles.contentBlock}>
          <motion.h3 initial="hidden" whileInView="visible" variants={textAnimationCustom} custom={0.25}>
            CoreLedger | TX.Mobile
          </motion.h3>
          <p>
            <motion.span initial="hidden" whileInView="visible" variants={textAnimationCustom} custom={0.5}>
          ...
          <motion.ul initial="hidden" whileInView="visible" variants={textAnimationCustom} custom={0.5}>
          ...
          <motion.h4 initial="hidden" whileInView="visible" variants={textAnimationCustom} custom={0.25}>
            Final team:
          </motion.h4>
          <motion.ul initial="hidden" whileInView="visible" variants={textAnimationCustom} custom={0.5}>
            <motion.li>2 React-Native developers</motion.li>
            <motion.li>Automotion QA</motion.li>
            <motion.li>Team leader</motion.li>
            <motion.li>Project manager</motion.li>
          </motion.ul>
          <motion.h3 initial="hidden" whileInView="visible" variants={textAnimationCustom} custom={0.25}>
            Process
          </motion.h3>
      ...
      <div className={(styles.WriteUs, styles.WriteUsTx)}>
        <WriteUs />
      </div>
    </div>
  );
